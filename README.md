...
Automatisiert geprüft und veröffentlicht ist der aktuelle Code als Development-Testbuild **`0.1.0-dev.115` (`26000115`)**. Build und Unit-Tests sind grün; die oben genannten UI-/Hardwareänderungen sind damit noch nicht als Gerätetest bestätigt.
