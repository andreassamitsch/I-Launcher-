...
internal object JoynLiveChannelMatcher {
    ...
    private val aliases = mapOf(
        ...
        "atvii" to "atv2",
        "atv2" to "atv2",
        "pro7maxx" to "prosiebenmaxx",
        "prosiebenmaxx" to "prosiebenmaxx",
        "orf2st" to "orfsteiermark",
        "orfst" to "orfsteiermark",
        "orf2steiermark" to "orfsteiermark",
        "orfsteiermark" to "orfsteiermark",
        "mdrsanhalt" to "mdrsachsenanhalt",
        "mdrsachsenanhalt" to "mdrsachsenanhalt",
        "ndrfsnds" to "ndrniedersachsen",
